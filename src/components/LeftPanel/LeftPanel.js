...
function LeftPanel() {
    ...
    function handleSearch(evt){
        ...
        document.getElementById("search_users_submit_btn").innerHTML = `<img src='${main_route}/images/loader.gif' style="width:1.5rem;height:1.5rem;"/>`;
    ...
    function handleSearchInChats(evt){
        ...
        // document.getElementById("search_users_submit_in_chats_btn").innerHTML = `<img src='${main_route}/images/loader.gif' style="width:1.5rem;height:1.5rem;"/>`;
        // document.getElementById("search_users_submit_in_chats_btn").disabled = true;

        local_searched_users = [];
        ...
        for(let i=0;i<list.length;i++){
            ...
            if((list[i].message_type.indexOf("one_to_one") > -1)){
                ...
                if(parseInt(list[i].sender_id) === parseInt(this_user)){                  
                    ...
                    if(list[i].receiver_nm.toLowerCase().includes(search_chars.toLowerCase())){                
                        local_searched_users.push(list[i]);
                    }
                }
                else{
            ...
            else if((list[i].message_type.indexOf("group") > -1)){      
                if(list[i].group_nm.toLowerCase().includes(search_chars.toLowerCase())){                  
                    local_searched_users.push(list[i]);
                }
            }
        
        }
        setSearchUsersInChats(local_searched_users);
            ...
            (
                ...
                <div className="p-2 bg-[rgb(16,118,255)] shadow-lg flex flex-row justify-between items-center">
                    <div className="flex w-full relative">
                        ...
                        <input id="search_users_in_chats_tf" onInput={handleSearchInChats} type="text" placeholder="Search users in chats" className='rounded-sm pl-2 pb-2 pt-2 pr-11 text-md bg-[rgba(255,255,255,0.8)] w-full'/>   
                ...
                <div className="bg-grey-lighter flex-1 overflow-auto relative">
                    ...
                    (chat_loading)?
                        ...
                        <div>
                            ...
                            <img src={`${main_route}/images/loader.gif`} className='w-10 h-10' />
                            <span>Loading...</span>
                            </div>
                        </div>
                        )
